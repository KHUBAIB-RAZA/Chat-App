    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
            <div className='pb-5'>
                ...
                <div className='bg-[#282142] rounded-full  flex items-center gap-2 py-3 px-4 mt-5'>
                    ...
                    <input onChange={(e) => setinput(e.target.value)} type="text" className='bg-transparent border-none outline-none text-white test-xs placeholder:[#c8c8c8] flex-1'
            ...
            <div className='flex flex-col'>
                ...
                rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                        ...
                        rounded-full bg-violet-500 text-white font-semibold">{unseenmessages[user._id]}</p>}
                    </div>
                ))}
